...
const logoUrl = 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-9vCGrF4OWF23UEtvlRDJ7VgrTKcWHp.png'
      ...
      <section id="inicio" className="relative mx-auto grid max-w-7xl items-center gap-12 px-5 pb-20 pt-12 sm:px-8 sm:pt-20 lg:grid-cols-[1.05fr_0.95fr] lg:px-12 lg:pb-28 lg:pt-24">
        ...
        <div className="relative flex min-h-[370px] items-center justify-center sm:min-h-[500px]">
          ...
          <div className="relative rotate-3 rounded-[2rem] border border-white/70 bg-[#ebe3d7] p-4 shadow-[0_25px_70px_rgba(80,55,25,0.12)] sm:p-6">
            <Image src={logoUrl} alt="Logo Pianíssima com monograma musical" width={310} height={310} className="h-56 w-56 rounded-[1.4rem] object-cover sm:h-[310px] sm:w-[310px]" priority />
          </div>
